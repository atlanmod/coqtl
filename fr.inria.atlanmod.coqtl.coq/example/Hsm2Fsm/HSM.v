...
Definition HSMMetamodel_getELinkFromERoleValues (hser_arg : HSMMetamodel_EReference) : (HSMMetamodel_getERoleTypesByEReference hser_arg) -> HSMMetamodel_ELink :=
  match hser_arg with
| StateMachineTransitionsEReference => (fun (p: (StateMachine * list Transition * list AbstractState)) => (Build_HSMMetamodel_ELink StateMachineTransitionsEReference (BuildStateMachineTransitions (fst (fst p)) (snd (fst p)) (snd p))))
| StateMachineStatesEReference => (fun (p: (StateMachine * list Transition * list AbstractState)) => (Build_HSMMetamodel_ELink StateMachineStatesEReference (BuildStateMachineStates (fst (fst p)) (snd (fst p)) (snd p))))
| TransitionStateMachineEReference => (fun (p: (Transition * StateMachine * AbstractState * AbstractState)) => (Build_HSMMetamodel_ELink TransitionStateMachineEReference (BuildTransitionStateMachine (fst (fst (fst p))) (snd (fst (fst p))) (snd (fst p)) (snd p))))
| TransitionSourceEReference => (fun (p: (Transition * StateMachine * AbstractState * AbstractState)) => (Build_HSMMetamodel_ELink TransitionSourceEReference (BuildTransitionSource (fst (fst (fst p))) (snd (fst (fst p))) (snd (fst p)) (snd p))))
| TransitionTargetEReference => (fun (p: (Transition * StateMachine * AbstractState * AbstractState)) => (Build_HSMMetamodel_ELink TransitionTargetEReference (BuildTransitionTarget (fst (fst (fst p))) (snd (fst (fst p))) (snd (fst p)) (snd p))))
| AbstractStateStateMachineEReference => (fun (p: (AbstractState * StateMachine * CompositeState)) => (Build_HSMMetamodel_ELink AbstractStateStateMachineEReference (BuildAbstractStateStateMachine (fst (fst p)) (snd (fst p)) (snd p))))
| AbstractStateCompositeStateEReference => (fun (p: (AbstractState * StateMachine * CompositeState)) => (Build_HSMMetamodel_ELink AbstractStateCompositeStateEReference (BuildAbstractStateCompositeState (fst (fst p)) (snd (fst p)) (snd p))))
| InitialStateStateMachineEReference => (fun (p: (InitialState * StateMachine * CompositeState)) => (Build_HSMMetamodel_ELink InitialStateStateMachineEReference (BuildInitialStateStateMachine (fst (fst p)) (snd (fst p)) (snd p))))
| InitialStateCompositeStateEReference => (fun (p: (InitialState * StateMachine * CompositeState)) => (Build_HSMMetamodel_ELink InitialStateCompositeStateEReference (BuildInitialStateCompositeState (fst (fst p)) (snd (fst p)) (snd p))))
| RegularStateStateMachineEReference => (fun (p: (RegularState * StateMachine * CompositeState)) => (Build_HSMMetamodel_ELink RegularStateStateMachineEReference (BuildRegularStateStateMachine (fst (fst p)) (snd (fst p)) (snd p))))
| RegularStateCompositeStateEReference => (fun (p: (RegularState * StateMachine * CompositeState)) => (Build_HSMMetamodel_ELink RegularStateCompositeStateEReference (BuildRegularStateCompositeState (fst (fst p)) (snd (fst p)) (snd p))))
| CompositeStateStateMachineEReference => (fun (p: (CompositeState * StateMachine * CompositeState * list AbstractState)) => (Build_HSMMetamodel_ELink CompositeStateStateMachineEReference (BuildCompositeStateStateMachine (fst (fst (fst p))) (snd (fst (fst p))) (snd (fst p)) (snd p))))
| CompositeStateCompositeStateEReference => (fun (p: (CompositeState * StateMachine * CompositeState * list AbstractState)) => (Build_HSMMetamodel_ELink CompositeStateCompositeStateEReference (BuildCompositeStateCompositeState (fst (fst (fst p))) (snd (fst (fst p))) (snd (fst p)) (snd p))))
| CompositeStateStatesEReference => (fun (p: (CompositeState * StateMachine * CompositeState * list AbstractState)) => (Build_HSMMetamodel_ELink CompositeStateStatesEReference (BuildCompositeStateStates (fst (fst (fst p))) (snd (fst (fst p))) (snd (fst p)) (snd p))))
  end.

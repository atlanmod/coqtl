...
| TreeOwnerSubtreeForZeroEReference => (fun (p: (Tree * Subtree)) => (Build_BDDMetamodel_ELink TreeOwnerSubtreeForZeroEReference (BuildTreeOwnerSubtreeForZero (fst p) (snd p))))
| TreeOwnerSubtreeForOneEReference => (fun (p: (Tree * Subtree)) => (Build_BDDMetamodel_ELink TreeOwnerSubtreeForOneEReference (BuildTreeOwnerSubtreeForOne (fst p) (snd p))))

...
Definition beq_Attribute (a1 : Attribute) (a2 : Attribute) : bool :=
  beq_nat (getAttributeId a1) (getAttributeId a2) && eqb (getAttributeMultivalued a1) (getAttributeMultivalued a2) && beq_string (getAttributeName a1) (getAttributeName a2).
...
- destruct (eqb (getAttributeMultivalued a1) (getAttributeMultivalued a2)) eqn: ca2.
  + apply (lem_beq_string_eq2) in H.
    apply (beq_nat_true) in ca1.

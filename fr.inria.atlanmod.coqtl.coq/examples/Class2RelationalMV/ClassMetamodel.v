...
Definition getAttributeId (a : Attribute) : string :=
  match a with BuildAttribute id derived name  => id end.
Definition getAttributeDerived (a : Attribute) : bool :=
  match a with BuildAttribute id derived name  => derived end.
Definition getAttributeName (a : Attribute) : string :=
  match a with BuildAttribute id derived name  => name end.
...
Definition getClassAttributesOnLinks (cl_arg : Class) (m : ClassModel) : option (list Attribute) :=
...
Definition getAttributeTypeOnLinks (at_arg : Attribute) (m : ClassModel) : option (Class) :=

...
Definition getTableColumnsOnLinks (ta_arg : Table) (m : RelationalModel) : option (list Column) :=
...
Definition getColumnReferenceOnLinks (co_arg : Column) (m : RelationalModel) : option (Table) :=

...
(Build_HSMMetamodel_ELink TransitionStateMachineEReference (BuildTransitionStateMachine (BuildTransition "t000" "0") (BuildStateMachine "SM1" "1"))) ::
(Build_HSMMetamodel_ELink AbstractStateStateMachineEReference (BuildAbstractStateStateMachine (BuildAbstractState RegularStateEClass (BuildRegularState "E000" "0")) (BuildStateMachine "SM1" "1"))) ::

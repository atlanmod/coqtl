...
Definition FSMMetamodel_getEAttributeTypesByEClass (fsec_arg : FSMMetamodel_EClass) : Set :=
  match fsec_arg with
    ...
    | FInitialStateEClass => (Empty_set)
    | FRegularStateEClass => (Empty_set)
  end.
...
Definition FSMMetamodel_getEObjectFromEAttributeValues (fsec_arg : FSMMetamodel_EClass) : (FSMMetamodel_getEAttributeTypesByEClass fsec_arg) -> FSMMetamodel_EObject :=
  match fsec_arg with
    ...
    | FInitialStateEClass => (fun (p: Empty_set) => (Build_FSMMetamodel_EObject FInitialStateEClass (BuildFInitialState)))
    | FRegularStateEClass => (fun (p: Empty_set) => (Build_FSMMetamodel_EObject FRegularStateEClass (BuildFRegularState)))
  end.

...
Definition HSMMetamodel_getEAttributeTypesByEClass (hsec_arg : HSMMetamodel_EClass) : Set :=
  match hsec_arg with
    ...
    | InitialStateEClass => (Empty_set)
    | RegularStateEClass => (Empty_set)
    | CompositeStateEClass => (Empty_set)
  end.
...
Definition HSMMetamodel_getEObjectFromEAttributeValues (hsec_arg : HSMMetamodel_EClass) : (HSMMetamodel_getEAttributeTypesByEClass hsec_arg) -> HSMMetamodel_EObject :=
  match hsec_arg with
    ...
    | InitialStateEClass => (fun (p: Empty_set) => (Build_HSMMetamodel_EObject InitialStateEClass (BuildInitialState)))
    | RegularStateEClass => (fun (p: Empty_set) => (Build_HSMMetamodel_EObject RegularStateEClass (BuildRegularState)))
    | CompositeStateEClass => (fun (p: Empty_set) => (Build_HSMMetamodel_EObject CompositeStateEClass (BuildCompositeState)))
  end.

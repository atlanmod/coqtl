...
Inductive InitialStateIsAbstractState : Set :=
   BuildInitialStateIsAbstractState :
   InitialState ->
   AbstractState ->
   InitialStateIsAbstractState.

Inductive RegularStateIsAbstractState : Set :=
   BuildRegularStateIsAbstractState :
   RegularState ->
   AbstractState ->
   RegularStateIsAbstractState.

Inductive CompositeStateIsAbstractState : Set :=
   BuildCompositeStateIsAbstractState :
   CompositeState ->
   AbstractState ->
   CompositeStateIsAbstractState.


(* Accessors *)
Definition getStateMachineName (s : StateMachine) : string :=
  match s with BuildStateMachine name StateMachineID  => name end.
Definition getStateMachineStateMachineID (s : StateMachine) : string :=
...
Definition getTransitionTransitionID (t : Transition) : string :=
...
Definition getAbstractStateAbstractStateID (a : AbstractState) : string :=
  match a with BuildAbstractState name AbstractStateID  => AbstractStateID end.
 
Definition getInitialStateInitialStateID (i : InitialState) : string :=
  match i with BuildInitialState InitialStateID  => InitialStateID end.
 
Definition getRegularStateRegularStateID (r : RegularState) : string :=
  match r with BuildRegularState RegularStateID  => RegularStateID end.
 
Definition getCompositeStateCompositeStateID (c : CompositeState) : string :=
  match c with BuildCompositeState CompositeStateID  => CompositeStateID end.
...
Definition HSMMetamodel_getEAttributeTypesByEClass (hsec_arg : HSMMetamodel_EClass) : Set :=
  match hsec_arg with
    | StateMachineEClass => (string * string)
    | TransitionEClass => (string * string)
    | AbstractStateEClass => (string * string)
...
| InitialStateIsAbstractStateEReference
| RegularStateIsAbstractStateEReference
| CompositeStateIsAbstractStateEReference
.
...
| InitialStateIsAbstractStateEReference => InitialStateIsAbstractState
| RegularStateIsAbstractStateEReference => RegularStateIsAbstractState
| CompositeStateIsAbstractStateEReference => CompositeStateIsAbstractState
  end.
...
| InitialStateIsAbstractStateEReference => (InitialState * AbstractState)
| RegularStateIsAbstractStateEReference => (RegularState * AbstractState)
| CompositeStateIsAbstractStateEReference => (CompositeState * AbstractState)
  end.
...
Definition HSMMetamodel_getEObjectFromEAttributeValues (hsec_arg : HSMMetamodel_EClass) : (HSMMetamodel_getEAttributeTypesByEClass hsec_arg) -> HSMMetamodel_EObject :=
  match hsec_arg with
    | StateMachineEClass => (fun (p: (string * string)) => (Build_HSMMetamodel_EObject StateMachineEClass (BuildStateMachine (fst p) (snd p))))
    | TransitionEClass => (fun (p: (string * string)) => (Build_HSMMetamodel_EObject TransitionEClass (BuildTransition (fst p) (snd p))))
    | AbstractStateEClass => (fun (p: (string * string)) => (Build_HSMMetamodel_EObject AbstractStateEClass (BuildAbstractState (fst p) (snd p))))
...
| InitialStateIsAbstractStateEReference => (fun (p: (InitialState * AbstractState)) => (Build_HSMMetamodel_ELink InitialStateIsAbstractStateEReference (BuildInitialStateIsAbstractState (fst p) (snd p))))
| RegularStateIsAbstractStateEReference => (fun (p: (RegularState * AbstractState)) => (Build_HSMMetamodel_ELink RegularStateIsAbstractStateEReference (BuildRegularStateIsAbstractState (fst p) (snd p))))
| CompositeStateIsAbstractStateEReference => (fun (p: (CompositeState * AbstractState)) => (Build_HSMMetamodel_ELink CompositeStateIsAbstractStateEReference (BuildCompositeStateIsAbstractState (fst p) (snd p))))
  end.

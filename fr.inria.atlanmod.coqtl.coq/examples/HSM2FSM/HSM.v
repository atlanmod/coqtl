...
( beq_string (StateMachine_getStateMachineName st_arg1) (StateMachine_getStateMachineName st_arg2) ) && 
( beq_string (StateMachine_getStateMachineStateMachineID st_arg1) (StateMachine_getStateMachineStateMachineID st_arg2) )
.

Definition beq_Transition (tr_arg1 : Transition) (tr_arg2 : Transition) : bool :=
( beq_string (Transition_getTransitionLabel tr_arg1) (Transition_getTransitionLabel tr_arg2) ) && 
( beq_string (Transition_getTransitionTransitionID tr_arg1) (Transition_getTransitionTransitionID tr_arg2) )
.

Definition beq_AbstractState (ab_arg1 : AbstractState) (ab_arg2 : AbstractState) : bool :=
( beq_string (AbstractState_getAbstractStateName ab_arg1) (AbstractState_getAbstractStateName ab_arg2) ) && 
( beq_string (AbstractState_getAbstractStateAbstractStateID ab_arg1) (AbstractState_getAbstractStateAbstractStateID ab_arg2) )
.
...
( beq_string (InitialState_getInitialStateInitialStateID in_arg1) (InitialState_getInitialStateInitialStateID in_arg2) )
.
...
( beq_string (RegularState_getRegularStateRegularStateID re_arg1) (RegularState_getRegularStateRegularStateID re_arg2) )
.
...
( beq_string (CompositeState_getCompositeStateCompositeStateID co_arg1) (CompositeState_getCompositeStateCompositeStateID co_arg2) )
.
...
Definition StateMachine_getStateMachineTransitions (st_arg : StateMachine) (m : HSMModel) : option (list Transition) :=
...
Definition StateMachine_getStateMachineStates (st_arg : StateMachine) (m : HSMModel) : option (list AbstractState) :=
...
Definition Transition_getTransitionStateMachine (tr_arg : Transition) (m : HSMModel) : option (StateMachine) :=
...
Definition Transition_getTransitionSource (tr_arg : Transition) (m : HSMModel) : option (AbstractState) :=
...
Definition Transition_getTransitionTarget (tr_arg : Transition) (m : HSMModel) : option (AbstractState) :=
...
Definition AbstractState_getAbstractStateStateMachine (ab_arg : AbstractState) (m : HSMModel) : option (StateMachine) :=
...
Definition AbstractState_getAbstractStateCompositeState (ab_arg : AbstractState) (m : HSMModel) : option (CompositeState) :=
...
Definition CompositeState_getCompositeStateStates (co_arg : CompositeState) (m : HSMModel) : option (list AbstractState) :=

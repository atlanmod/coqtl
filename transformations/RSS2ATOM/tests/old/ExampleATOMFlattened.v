...
Definition InputModel : Model ATOMMetamodel_Object ATOMMetamodel_Link :=
	(Build_Model
		...
		(Build_ATOMMetamodel_Object AuthorClass (BuildAuthor  "John Doe"  (Some "")  (Some "johndoe@example.com"))) :: 
		...
		(Build_ATOMMetamodel_Link AuthorAtomReference (BuildAuthorAtom (BuildAuthor  "John Doe"  (Some "")  (Some "johndoe@example.com")) (BuildATOM  "Example ATOM" "urn:uuid:60a76c80-d399-11d9-b91C-0003939e0af6"  (Some "Insert witty or insightful remark here")  (Some "")  (Some "")  (Some "") "2003-12-13T18:30:02Z"))) ::
		...
		(Build_ATOMMetamodel_Link ATOMAuthorsReference (BuildATOMAuthors (BuildATOM  "Example ATOM" "urn:uuid:60a76c80-d399-11d9-b91C-0003939e0af6"  (Some "Insert witty or insightful remark here")  (Some "")  (Some "")  (Some "") "2003-12-13T18:30:02Z") ((BuildAuthor  "John Doe"  (Some "")  (Some "johndoe@example.com")) :: nil ))) ::
